    ...
    <View style={styles.header}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          Welcome to StayLit. These Terms and Conditions govern your access to and use of our app and services. By using our app, you agree to comply with these Terms. If you do not agree to these Terms, please do not use our services.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.bulletContainer}>
          <Entypo name="dot-single" size={18} style={styles.bullet} />
          <Text style={styles.bulletText}>
            <Text style={styles.bold}>Listing Requirements:</Text> Agents must provide accurate and complete information about their properties, including descriptions, photos, pricing, and availability.
          </Text>
        </View>
        <View style={styles.bulletContainer}>
          <Entypo name="dot-single" size={18} style={styles.bullet} />
          <Text style={styles.bulletText}>
            <Text style={styles.bold}>Responsibility:</Text> Agents are responsible for ensuring that their properties comply with all applicable laws, regulations, and local ordinances.
          </Text>
        </View>
        <View style={styles.bulletContainer}>
          <Entypo name="dot-single" size={18} style={styles.bullet} />
      ...
      <View style={styles.section}>
        ...
        <View style={styles.bulletContainer}>
          <Entypo name="dot-single" size={18} style={styles.bullet} />
          <Text style={styles.bulletText}>
            <Text style={styles.bold}>Renting Process:</Text> Renters can rent properties through our app by following the booking process outlined in the app. Once a payment is confirmed, a legally binding agreement is formed between the agent and renter.</Text>
        </View>
        <View style={styles.bulletContainer}>
          <Entypo name="dot-single" size={18} style={styles.bullet} />
          <Text style={styles.bulletText}>
        ...
        <View style={styles.bulletContainer}>
          <Entypo name="dot-single" size={18} style={styles.bullet} />
          <Text style={styles.bulletText}>
            <Text style={styles.bold}>Cancellations and Refunds:</Text> Cancellation and refund policies are determined by the agent and will be outlined in the property listing. Renters should review these policies carefully before booking.
          </Text>
        </View>
      </View>
    </ScrollView>
