    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
                ...
                <View style={styles.mainContainer}>
                    <View>
                        <Text style={styles.leotPrivacyLabel}>StayLit Privacy</Text>
                        <Image source={require('../../../assets/privacyImage.jpg')} style={styles.imageStyle}/>
                    </View>
                    <View style={{marginVertical: 20}}>
                        <Text style={styles.descText}>Welcome to StayLit, we are committed to protecting your privacy and ensuring that your personal information is handled securely and responsibly. This Privacy Policy outlines how we collect, use, and protect your data when you use our app or interact with our services.</Text>
                        ...
                        <View style={{marginBottom: 10}}>
                            <Text style={styles.privacyText}><Text style={styles.privacyTextBold}>Usage Data:</Text> Information about how you interact with our app, including search queries, viewed properties, and communication between agents and renters.</Text>
                        </View>
                        <View style={{marginBottom: 10}}>
                    ...
                    <View>
                        ...
                        <View style={styles.privacyPolicyCont}>
                                ...
                                <Text style={styles.privacyText}>Facilitate the renting process between agents and renters.</Text>
                        </View>
                        <View style={styles.privacyPolicyCont}>
                                <Entypo name="dot-single" size={28} color="black" style={{marginRight: 5}}/>
                        ...
                        <View style={{marginTop: 20}}>
                            ...
                            <View style={{...styles.alignContainer, marginBottom: 5}}>
                                    <Entypo name="dot-single" size={28} color="black" style={{marginRight: 5}}/>
                                    <Text style={{...styles.privacyText, paddingRight: 5}}><Text style={styles.privacyTextBold}>Agents and Renters: </Text>To facilitate the renting process, relevant information will be shared between parties involved in a transaction.</Text>
                            </View>
                            <View style={styles.privacyPolicyCont}>
                                    <Entypo name="dot-single" size={28} color="black" style={{marginRight: 5}}/>
