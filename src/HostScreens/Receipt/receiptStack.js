...
import { View, Text, Pressable, StyleSheet, Image, useWindowDimensions, Modal } from 'react-native'
...
const ReceiptStack = ()=>{
    ...
    const { apartment, hostData, payment} = route.params
    ...
    const captureAndConvertToPDF = () => {
      ...
      const convertImageToPDF = async (imageUri) => {
        try {
          ...
          // Optionally, share the PDF or use it as needed
   ...
   const getUserName = async ()=>{
    try{
      ...
      console.log('Error query user : ', e.message )
    }
   ...
   useEffect(()=>{
    ...
    if(!userName){
            return(
              <Modal visible={true} onRequestClose={()=>{navigation.goBack()}} presentationStyle='overFullScreen'>
                   ...
                   <View style={styles.chargedPriceContainer}>
                    <Text style={styles.transferText}>Transfer to StayLit</Text>
                        ...
                        <View style={styles.alignContainer}>
                            <Ionicons name="checkmark-circle" size={24} color="#F52F57" style={{marginRight: 5}}/>
                        ...
                        <View style={{...styles.alignContainer, justifyContent:'space-between'}}>
                            ...
                            {payment.type == 'CARD'? <View>
                                    ...
                                    <View style={{width: '60%'}}> 
                                        ...
                                        <Text style={styles.receiptTabText}>StayLit | Host</Text>
                                     </View>
                            }
                         </View>
